...
public class TestResizerIterBiliJis extends TestResizerWithScaler {

    //--------------------------------------------------------------------------
    // CONSTRUCTORS
    //--------------------------------------------------------------------------
    
    public TestResizerIterBiliJis(int dstAreaThresholdForSplit) {
    ...
    public InterfaceTestResizer withMaxSplitThresholds() {
        return new TestResizerIterBiliJis(Integer.MAX_VALUE);
    }
}
