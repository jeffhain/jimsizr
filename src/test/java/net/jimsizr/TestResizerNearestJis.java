...
public class TestResizerNearestJis extends TestResizerWithScaler {

    //--------------------------------------------------------------------------
    // CONSTRUCTORS
    //--------------------------------------------------------------------------
    
    public TestResizerNearestJis(int dstAreaThresholdForSplit) {
        super(new ScalerNearestJis(
    ...
    public InterfaceTestResizer withMaxSplitThresholds() {
        return new TestResizerNearestJis(Integer.MAX_VALUE);
    }
}
