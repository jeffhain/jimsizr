...
public class TestResizerBoxsampledJis extends TestResizerWithScaler {

    //--------------------------------------------------------------------------
    // CONSTRUCTORS
    //--------------------------------------------------------------------------
    
    public TestResizerBoxsampledJis(
        int srcAreaThresholdForSplit,
        int dstAreaThresholdForSplit) {
        super(new ScalerBoxsampledJis(
    ...
    public InterfaceTestResizer withMaxSplitThresholds() {
        return new TestResizerBoxsampledJis(
            Integer.MAX_VALUE,
            Integer.MAX_VALUE);
    }
}
